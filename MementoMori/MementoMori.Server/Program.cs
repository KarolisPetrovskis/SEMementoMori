...
using MementoMori.Server.Services;
...
builder.Services.AddSingleton(new ConcurrentQueue<(Guid UserId, Guid DeckId, Guid CardId, int Quality)>());
builder.Services.AddSingleton<CardUpdateProcessor>();
